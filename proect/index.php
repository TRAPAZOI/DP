...
<section>
    ...
    <div class="image-container">
        ...
        <div class="image-block">
            ...
            <div class="image-description">Мы помогаем вам выбрать оптимальные сорта подсолнухов, пшеницы и ячменя. 
        ...
        <div class="image-block">
            ...
            <div class="image-description">Мы сотрудничаем с надежными поставщиками, предлагая высококачественные семена и удобрения. 
        ...
        <div class="image-block">
            ...
            <div class="image-description">ООО "Волна" активно внедряют передовые технологии в процесс выращивания. Мы  примененяем современные методы орошения.
            </div>
        </div>
    </div>
</section>
